...
| Endpoint | ~мс/оп | ~запросов/сек |
|---|---|---|
| REST /api/incline full | 0.0159 | 63 000 |
| REST /api/incline initials | 0.0158 | 63 300 |
| REST /api/gender | 0.0105 | 95 300 |
| REST /api/city/in | 0.0086 | 116 100 |
| REST /api/city/from | 0.0085 | 117 100 |
| REST /api/city/to | 0.0067 | 149 500 |
| SOAP Incline | 0.0253 | 39 500 |

Параллельная нагрузка (все ядра, `b.RunParallel`):

| Endpoint | ~мс/оп | ~запросов/сек |
|---|---|---|
| REST /api/incline full | 0.0060 | 167 200 |
| REST /api/gender | 0.0041 | **244 000** |
| REST /api/city/in | 0.0037 | **273 300** |
| REST /api/city/from | 0.0037 | 271 400 |
| REST /api/city/to | 0.0033 | **306 000** |
| SOAP Incline | 0.0107 | 93 500 |

До **306 000 запросов/сек** (city/to) при параллельной нагрузке. Для сравнения:
