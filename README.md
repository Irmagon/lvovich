...
|---|---|---|---|---|
| REST /api/incline full | 0.0163 | 61 300 | 0.0138 | 72 300 |
| REST /api/incline initials | 0.0164 | 61 000 | — | — |
| REST /api/gender | 0.0107 | 93 700 | 0.0088 | 114 100 |
| REST /api/city/in | 0.0087 | 114 800 | — | — |
| REST /api/city/from | 0.0087 | 114 600 | — | — |
| REST /api/city/to | 0.0068 | 146 900 | 0.0052 | 192 000 |
| SOAP Incline | 0.0260 | 38 400 | 0.0212 | 47 300 |
...
| REST /api/gender | 0.0042 | **237 800** | 0.0035 | **285 100** |
| REST /api/city/in | 0.0038 | 263 400 | — | — |
| REST /api/city/from | 0.0038 | 266 400 | — | — |
| REST /api/city/to | 0.0033 | 302 000 | 0.0026 | **377 500** |
| SOAP Incline | 0.0111 | 90 100 | 0.0093 | 107 100 |

С отключённым логом — до **377 500 запросов/сек** (city/to) при параллельной
нагрузке, прирост ~25% относительно режима с логированием.
